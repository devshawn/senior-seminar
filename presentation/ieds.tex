    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 2cm) % {block width} (coords)
          \begin{figure}
            \centering
            \includegraphics[width=6cm]{../figures/algorithm1-slide-25.pdf}
            \caption*{A simple, undirected graph $G$}
          \end{figure}
        \end{textblock*}
      \end{center}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 2cm) % {block width} (coords)
          \begin{figure}
            \centering
            \includegraphics[width=6cm]{../figures/algorithm1-slide-2.pdf}
            \caption*{A simple, undirected graph $G$}
          \end{figure}
        \end{textblock*}
      \end{center}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 2cm) % {block width} (coords)
          \begin{figure}
            \centering
            \includegraphics[width=6cm]{../figures/algorithm1-slide-3.pdf}
            \caption*{A simple, undirected graph $G$}
          \end{figure}
        \end{textblock*}
      \end{center}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 3cm) % {block width} (coords)
          \begin{figure}
            \centering
            \includegraphics[width=5cm]{../figures/algorithm1-slide-4.pdf}
            \caption*{$G$ after lines 14-15}
          \end{figure}
        \end{textblock*}
      \end{center}
    \end{column}
...
\only<11>{
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 3.5cm) % {block width} (coords)
          \begin{figure}
            \centering
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}
        \begin{textblock*}{8cm}(8cm, 3cm) % {block width} (coords)
          \begin{figure}
            \centering
            \includegraphics[width=5cm]{../figures/algorithm1-slide-5.pdf}
